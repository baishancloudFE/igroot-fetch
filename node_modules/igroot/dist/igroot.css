...
.ant-btn-group .ant-btn-primary:not(:first-child):not(:last-child) {
  border-right-color: #1886e0;
  border-left-color: #1886e0;
}
...
.ant-btn-circle.ant-btn-md,
.ant-btn-circle-outline.ant-btn-md {
  width: 24px;
  padding: 0;
  font-size: 12px;
  border-radius: 50%;
...
.ant-btn-md.ant-btn-loading:not(.ant-btn-circle):not(.ant-btn-circle-outline) {
  padding-left: 24px;
}
.ant-btn-md.ant-btn-loading:not(.ant-btn-circle):not(.ant-btn-circle-outline) .anticon {
  margin-left: -17px;
}
.ant-btn-group {
  position: relative;
...
.ant-btn-group-md > .ant-btn > .anticon {
  font-size: 12px;
}
...
.ant-radio-button-wrapper-checked:hover {
  border-color: #55b7ff;
  box-shadow: -1px 0 0 0 #55b7ff;
  color: #55b7ff;
}
.ant-radio-button-wrapper-checked:active {
  border-color: #1886e0;
  box-shadow: -1px 0 0 0 #1886e0;
  color: #1886e0;
}
...
.ant-calendar .ant-calendar-ok-btn-md {
  padding: 0 28px;
  font-size: 10px;
  border-radius: 3px;
  height: 24px;
...
.has-warning .ant-input:focus {
  border-color: #ffe65c;
  outline: 0;
  box-shadow: 0 0 0 2px rgba(255, 222, 41, 0.2);
}
...
/*# sourceMappingURL=igroot.css.map*/